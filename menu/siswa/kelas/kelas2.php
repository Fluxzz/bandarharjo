    ...
    <div class="container">
        ...
        <div class="navbar-item">
            <div class="navigation">
                ...
                <div class="selection">
                    <div class="option" onclick="window.location.href='?kelas=2A'">
                        <p>Kelas 2A</p>
                    </div>
                    <div class="option" onclick="window.location.href='?kelas=2B'">
                        <p>Kelas 2B</p>
                    </div>
                    <div class="option" onclick="window.location.href='?kelas=2C'">
                        <p>Kelas 2C</p>
                    </div>
                </div>
            </div>
