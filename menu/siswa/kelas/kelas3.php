    ...
    <div class="container">
        ...
        <div class="navbar-item">
            <div class="navigation">
                ...
                <div class="selection">
                    <div class="option" onclick="window.location.href='?kelas=3A'">
                        <p>Kelas 3A</p>
                    </div>
                    <div class="option" onclick="window.location.href='?kelas=3B'">
                        <p>Kelas 3B</p>
                    </div>
                    <div class="option" onclick="window.location.href='?kelas=3C'">
                        <p>Kelas 3C</p>
                    </div>
                </div>
            </div>
