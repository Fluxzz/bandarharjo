...
if (isset($_POST['hapus_nisn']) && isset($_SESSION['role']) && $_SESSION['role'] === 'admin') {
    ...
    if ($stmt = $conn->prepare($deleteQuery)) {
        ...
        $stmt->execute();
        echo "<script>window.location.href = 'kelas1.php?kelas=1$kategori';</script>";
        exit();
    }
}

// Ambil data siswa
$query = "SELECT * FROM siswa1 WHERE kategori='$kategori'";
    ...
    <div class="container">
        ...
        <div class="navbar-item">
            <div class="navigation">
                ...
                <div class="selection">
                    <div class="option" onclick="window.location.href='?kelas=1A'">
                        <p>Kelas 1A</p>
                    </div>
                    <div class="option" onclick="window.location.href='?kelas=1B'">
                        <p>Kelas 1B</p>
                    </div>
                    <div class="option" onclick="window.location.href='?kelas=1C'">
                        <p>Kelas 1C</p>
                    </div>
                </div>
            </div>
